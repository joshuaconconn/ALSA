...
public class CreateWorkOutProgAdapter extends RecyclerView.Adapter<CreateWorkOutProgAdapter.UserViewHolder>{
    private List<CreateWorkOutProgModel> list;
    Activity context;

    public CreateWorkOutProgAdapter(List<CreateWorkOutProgModel> list){
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull final UserViewHolder holder, int position) {
        ...
        holder.itemView.setOnCreateContextMenuListener(new View.OnCreateContextMenuListener() {
            ...
            public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
                menu.add(holder.getAdapterPosition(), 0,0, "Add Exercises");
