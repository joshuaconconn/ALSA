...
public class AcceptClassAdapter extends RecyclerView.Adapter<AcceptClassAdapter.UserViewHolder>{


    private List<AcceptClassModel> list;
    Activity context;

    public AcceptClassAdapter(List<AcceptClassModel> list){
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull final UserViewHolder holder, int position) {
        final AcceptClassModel user = list.get(position);
        ...
        holder.itemView.setOnCreateContextMenuListener(new View.OnCreateContextMenuListener() {
            ...
            public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
                menu.add(holder.getAdapterPosition(), 0,0, "Accept");
